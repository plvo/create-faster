...
interface TerminalProps {
  children: React.ReactNode;
  className?: string;
  cliNav?: React.ReactNode;
  sequence?: boolean;
  startOnView?: boolean;
}

export const Terminal = ({ children, cliNav, className, sequence = true, startOnView = true }: TerminalProps) => {
    ...
    >
      ...
      <pre className='p-4'>
        <code className='grid gap-y-1 overflow-auto'>
          <ScrollArea className='h-96 bg-white dark:bg-transparent'>
