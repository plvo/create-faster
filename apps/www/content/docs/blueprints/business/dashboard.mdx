---
title: Dashboard
description: A production-ready internal dashboard starter with authentication, a collapsible sidebar, stats overview, and a settings page. Built on Next.js with shadcn/ui components, Better Auth for login, and Recharts for data visualization.
---
