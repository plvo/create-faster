...
This blueprint ships `AGENTS.md` + `docs/agents/` guides (architecture, SEO & GEO, content & blog, analytics & consent) so AI coding agents understand the project out of the box. See [Agent Context](/docs/concepts/agent-context).
