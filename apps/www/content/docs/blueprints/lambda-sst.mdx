...
Serverless monorepo for AWS Lambda using SST Ion as the infrastructure framework. Generates three Lambda functions behind API Gateway, SQS, and EventBridge, with a shared types package and GitHub Actions CI/CD using OIDC authentication.
