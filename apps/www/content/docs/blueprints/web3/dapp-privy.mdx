...
This blueprint ships `AGENTS.md` + `docs/agents/` guides (architecture, wallet auth, data layer) so AI coding agents understand the project out of the box. See [Agent Context](/docs/concepts/agent-context).
