...
Blueprints define the stacks, libraries, database, ORM, and sometimes deployment. You choose the linter, tooling, git, and package manager. See [Blueprints](/docs/concepts/blueprints) for details.
