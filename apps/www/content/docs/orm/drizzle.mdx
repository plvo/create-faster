...
**Requires:** Database (PostgreSQL, MySQL, or SQLite)
...
export default defineConfig({
  ...
  out: './drizzle',
  dialect: 'postgresql', // or 'mysql' / 'sqlite' based on database selection
  dbCredentials: {
...
- **SQLite**: `drizzle-orm/libsql` (runtime-agnostic libSQL driver, relative paths anchored to the db package root — see [SQLite](/docs/database/sqlite))
