...
```bash
bunx create-faster my-dashboard --blueprint dashboard --linter biome --git --pm bun
```

Blueprints generate complete, functional applications — with pages, layouts, components, and routes. Available blueprints include dashboards, Web3 dApps, and serverless Lambda architectures. See [Blueprints](/docs/blueprints) for all options.
