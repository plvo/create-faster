...
**Terraform (Cloudflare)**: Generates a complete `infra/` directory with Cloudflare provider, R2 state backend, SOPS-encrypted secrets, and a justfile. See [Terraform (Cloudflare)](/docs/deployment/terraform-cloudflare).
