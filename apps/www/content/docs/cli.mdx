...
**Terraform (Cloudflare)**: Generates a complete `infra/` directory with Cloudflare provider, R2 state backend, gitignored secrets placeholders, and a justfile. See [Terraform (Cloudflare)](/docs/deployment/terraform-cloudflare).
